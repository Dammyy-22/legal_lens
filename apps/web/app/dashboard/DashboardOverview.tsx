...
export default function DashboardOverview({ email }: { email: string }) {
  return (
    <div className="max-w-5xl mx-auto px-6 py-10 md:py-14">
      <div className="mb-10 animate-ink-in">
        ...
        <p className="text-ink-400">
          Signed in as {email}. Here&apos;s what you can do on LegalLens.
        </p>
      </div>

      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-14">
        <NavCard href="/dashboard/ask" mark="§" title="Ask a question" comingSoon>
          Ask about laws, rights, and procedures in Nigeria. Answers will be grounded
          and cited to real sources.
        </NavCard>
        <NavCard href="/dashboard/search" mark="¶" title="Search the law" comingSoon>
          Search Nigerian legislation and regulations with semantic understanding.
        </NavCard>
        <NavCard href="/dashboard/constitution" mark="⚑" title="Constitution">
          Browse the Constitution of the Federal Republic of Nigeria by part and
          section.
        </NavCard>
        <NavCard href="/dashboard/rights" mark="⚖" title="Rights explorer">
          Structured guidance for common situations — police stops, tenancy, the
          workplace, and more.
        </NavCard>
        <NavCard href="/dashboard/lawyers" mark="⌘" title="Find a lawyer">
          Browse legal practice areas and join the waitlist for verified lawyer
          referrals.
        </NavCard>
        <NavCard href="/dashboard/documents" mark="⎘" title="My documents" comingSoon>
