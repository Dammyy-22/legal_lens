      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p className="text-sm text-yellow-800">
            <strong>⚠️ Important Disclaimer:</strong> LegalLens is an AI-powered legal information tool for educational purposes. It is not a lawyer and does not provide legal advice. Always consult with a qualified attorney for legal matters affecting your rights or obligations.
          </p>
        </div>
      </main>
    </div>
