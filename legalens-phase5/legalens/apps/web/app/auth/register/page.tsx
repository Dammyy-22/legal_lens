    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center px-4">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200 text-xs text-gray-600">
          ...
          <p>
            LegalLens is a legal information tool, not a lawyer. We help you understand laws and procedures
            in Nigeria, but do not provide legal advice. Always consult a qualified attorney for your specific situation.
          </p>
        </div>
      </div>
    </div>
